...
public interface CategoryTreeService {
     ...
     */
    CategoryTree getCategoryGroup(String categoryGroup, long lastSeen);
     ...
     */
    List<CategoryTree> getCategoryGroups(List<String> categoryGroups, long lastSeen) throws Exception;
