...
public class CategoryProfile {
    ...
    //ServiceType is the type of the service that this category is powering. You can think of it
    //as a categoryGroup. If multiple categories (defined by categoryIds) belong to one group, this
    //is the entry that reflects the group
